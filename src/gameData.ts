...
export const ITEMS: Record<string, GameItem> = {
  ...
  'c_empty_box_c': {
    ...
    price: 500,
    color: '#8b5a2b',
    effect: { description: '中にアイテムを詰めてギルドショップやオークションで売れる。Cランク以下のアイテムを何個でも好きなだけ詰められる。' }
  },
  'c_empty_box_b': {
    id: 'c_empty_box_b',
    name: '空の木箱 (Bランク)',
    ...
    price: 5000,
    color: '#cd853f',
    effect: { description: '中にアイテムを詰めてギルドショップやオークションで売れる。Bランク以下のアイテムを何個でも好きなだけ詰められる。' }
  },
  'c_empty_box_a': {
    id: 'c_empty_box_a',
    name: '空の宝箱 (Aランク)',
    ...
    price: 50000,
    color: '#ffd700',
    effect: { description: '中にアイテムを詰めてギルドショップやオークションで売れる。Aランク以下のアイテムを何個でも好きなだけ詰められる。' }
  },
  'c_transfer_scroll': {
